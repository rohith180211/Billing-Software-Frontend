...
const Item = ({itemName,itemPrice,itemImage,itemId}) => {
    return (
        <div className="p-3 bg-dark rounded shadow-small h-100 d-flex align-items-center item-card">
            ...
            <div className="d-flex flex-column justify-content-between align-items-center ms-3 " style={{height:'100%'}}>
                ...
                <button className="btn btn-success btn-sm" onClick={hangleAddToCart}>
